        ...
        <div className={styles.wrap}>
            ...
            {!data.captain ? (
                ...
                <>
                    <div className={styles.card}>
                        ...
                        <details className={styles.details}>
                            <summary className={styles.summary}>
                                ...
                                <span className={styles.summaryHint}>Update name / bio / phone</span>
                            </summary>
                    ...
                    <div className={styles.card}>
                        <h2 className={styles.h2}>Boats</h2>
                        <details className={styles.details}>
                            <summary className={styles.summary}>
                                <span>Add a boat</span>
                                <span className={styles.summaryHint}>Create a new listing</span>
                            </summary>
                            <div className={styles.detailsBody}>
                                ...
                                {data.captain.boats.map((b) => (
                                    <div key={b.id} className={styles.boat}>
                                        ...
                                        <details className={styles.details}>
                                            <summary className={styles.summary}>
                                                <span>Edit boat</span>
                                                <span className={styles.summaryHint}>Name / photos / pricing</span>
                                            </summary>
                                            <div className={styles.detailsBody}>
